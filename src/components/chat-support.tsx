  ...
  return (
    <ExpandableChat size="md" position="bottom-right">
      <ExpandableChatHeader className="bg-muted/60 flex-col text-center justify-center">
        <h1 className="text-xl font-semibold">Consulta sobre Revisión Técnica Vehicular 🚗</h1>
        <p>Asesor Virtual de Revisiones Técnicas</p>
      ...
      <ExpandableChatBody>
        <ChatMessageList className="bg-muted/25" ref={messagesRef}>
          ...
          <ChatBubble variant="received">
            ...
            <ChatBubbleMessage>
              ¡Hola! Soy tu asistente virtual. ¿En qué te puedo ayudar con tu revisión técnica?
            </ChatBubbleMessage>
          </ChatBubble>
